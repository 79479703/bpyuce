...
class RobustDynamicBooster:
    def __init__(self, base_input_dim, ablation_config,
                 n_estimators=200, base_lr=0.1, residual_steps=10,
                 xgboost_params=None):
        self.ablation = ablation_config
    ...
    def fit(self, X, y, val_ratio=0.2):
        ...
        for epoch in progress:
            ...
            model = HybridXGBModel(
                alpha=0.3 if self.ablation.get('use_hybrid_loss', True) else 0.0,
