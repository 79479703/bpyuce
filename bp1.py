...
P_train = res[temp[:120], 1:8].T
T_train = res[temp[:120], 8].T
M = P_train.shape[1]
P_test = res[temp[120:], 1:8].T
T_test = res[temp[120:], 8].T
N = P_test.shape[1]
...
# 创建网络
net = MLPRegressor(hidden_layer_sizes=(10), max_iter=1000, tol=1e-6, learning_rate_init=0.05)
